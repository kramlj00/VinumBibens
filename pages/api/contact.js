...
async function sendEmail(req, res) {
  ...
  try {
    await sendgrid.send({
      ...
      subject: "Vinum Bibens",
      text: `Novi upit za Vinum Bibens od ${name}. Email: ${email} Poruka: ${message}`,
      html: `<div style="color:#444444; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:Center;">
        ...
        <h1 style="line-height:30px; margin-bottom:10px;">Novi upit za Vinum Bibens od ${name}</h1>
